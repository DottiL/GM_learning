...
public class AdminLayout {
	...
	public AdminLayout(List<Course> courses) {
	...
	private String insertCourse(Course c) {
		return "<tr>" +
					insertCourseFiled(Integer.toString(c.getId())) +
					insertCourseFiled(c.getCourseName()) +
					insertCourseFiled(c.getLocation()) +
					insertCourseFiled(Integer.toString(c.getTotalSeats())) +
					insertCourseFiled(c.getStartingDate()) +
				"</tr>";
		
	}
	
	private String insertCourseFiled(String field) {
		return "<td>" + field + "</td>";
	}
}
